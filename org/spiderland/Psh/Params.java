...
public class Params {
    ...
    public static HashMap< String, String > Read( String inParams ) throws Exception {
	HashMap< String, String > map = new HashMap< String, String >();
	return Read( inParams, map, null );
    }

    public static HashMap< String, String > Read( String inParams, HashMap< String, String > inMap, File inFile ) throws Exception {
	int linenumber = 0;
